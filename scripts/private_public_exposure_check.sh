...
if command -v ss >/dev/null 2>&1; then
    ...
    ss -tlnp | grep -E '127\.0\.0\.1:(8001|3000)' || echo "   None found or not running."
    ...
    ss -tlnp | grep -E "(0\.0\.0\.0|::|${PUBLIC_IP}):(3000|8001|8080)" && echo "   WARNING: App ports exposed publicly!" || echo "   PASS: App ports not bound to 0.0.0.0."
else
